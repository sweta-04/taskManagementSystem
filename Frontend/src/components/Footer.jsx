            ...
            <div className="w-auto p-8">
              <a href="/">
                <div className="inline-flex items-center" >
                  <Logo width="50px" />
                  <span className="ml-4 text-lg font-bold">Task Management System</span>
